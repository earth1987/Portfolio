...
A movie recommendation system is developed using alternating least squares and implemented using in Apache Spark via PySpark. Google Cloud Dataproc is used to deploy a Spark cluster during model training.
